                ...
                <div class="panel-body">
                    <form role="form" method="POST" action=" " >
                        <fieldset>
                             ...
                             <label> Candidate's Name:</label><input class="form-control" placeholder="Candidate's Name" name="cname" type="text" maxlength="20" autofocus>
                            </div>
                            <div style="color: red;" class="mandatory">*</div>

                            <div class="form-group">
                              <label>Father's Name:</label> <input class="form-control" placeholder="Father's Name" name="fname" type="text" maxlength="20" autofocus>
                            </div>
                            <div style="color: red;" class="mandatory">*</div>
                            <div class="form-group">
                              <label>Mother's Name:</label> <input class="form-control" placeholder="mother's Name" name="mname" type="text" maxlength="20" autofocus>
                            </div>
                            <div style="color: red;" class="mandatory">*</div>
                             <div class="form-group">
                          ...
                          <select name="monthname" class="form-control">
                               ...
                               <div class="form-group">
                                ...
                                <input class="form-control" name="anumberr" type="Number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="16">
                            </div>
                            <div style="color: red;" class="mandatory">*</div>
                            <div class="form-group">
                            ...
                            <div style="color: red;" class="mandatory">*</div>
                               <div class="form-group">
                                ...
                                <textarea class="form-control" id="exampleTextarea" rows="5" placeholder="Address" name="Address" maxlength="200"></textarea>
                            </div>
